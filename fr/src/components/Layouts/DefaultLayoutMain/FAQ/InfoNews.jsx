        ...
        <Grid item xs={12}>
          <Item>
            ...
            <Typography gutterBottom variant="body2">
              ...
              <ul>
                <li>Обновлены запросы в лабораторию:</li>
                <li>Закрытые контракты\запросы после прочтения доступны в подразделе запросов.</li>
                <li>Исправлены расчеты отклонений при формировании отчета.</li>
                <li>Расширенно описание для уведомлений по операциям.</li>
                <li>Сотрудникам отдела реализации доступна возможность сформировать запрос на основании предыдущих\заключены контрактов.</li>
              </ul>
