...
export const CrUpCosFForm = ({ onClose, isEdit, dataToEdit, popupSnackbar, response }) => {
  ...
  const handleSubmit = async e => {
    ...
    const endpoint = isEdit
      ? "/admin/devices/motor/electrical/cosF/update"
      : "/admin/devices/motor/electrical/cosF/create"
    try {
