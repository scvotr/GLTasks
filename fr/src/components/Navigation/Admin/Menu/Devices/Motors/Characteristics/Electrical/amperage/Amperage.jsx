...
import { CrUpAmperageForm } from "./CrUpAmperageForm"
import { fetchDataV2 } from "../../../../../../../../../utils/fetchDataV2"
import { Loader } from "../../../../../../../../FormComponents/Loader/Loader"

export const Amperage = () => {
  //? const sections = [{ path: "/admin/devices/motor/Amperage/...", label: "Мощность кВт" }]
  ...
  const getData = useCallback(() => {
    const endpoint = "/admin/devices/motor/electrical/amperage/read"
  ...
  const handleDelete = async () => {
    const endpoint = `/admin/devices/motor/electrical/amperage/delete`
    try {
  ...
  return (
    <>
      <ModalCustom isOpen={modalOpen} onClose={closeModal} infoText="Добавить номинальный ток">
        <CrUpAmperageForm
          onClose={closeModal}
          isEdit={isEdit}
      ...
      <HeaderWithNavigation
        title="Номинальный ток А (амперы), обозначается Iн"
        //? sections={sections}
      ...
      <Box>
        <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
          Указывается номинальный ток, равный току в обмотках двигателя при выходе на нормальный режим работы. Пусковой
          ток всегда больше.
        </Typography>
      </Box>
