...
import { MechanicalSpecifications } from "./MainPageContent/MechanicalSpecifications"
...
export const Mechanical = () => {
  ...
  const sections = [
    { path: "/admin/devices/motor/mechanical/rotationSpeed", label: "Частота вращения" },
    { path: "/admin/devices/motor/mechanical/torque", label: "Номинальный момент силы Мн" },
    { path: "/admin/devices/motor/mechanical/temperature", label: "Температурный режим: B,H,F" },
    { path: "/admin/devices/motor/mechanical/operationMode", label: "Режим работы S*" },
  ]
