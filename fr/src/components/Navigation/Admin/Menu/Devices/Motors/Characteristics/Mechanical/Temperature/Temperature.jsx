...
export const Temperature = () => {
  const endpointPath = "mechanical/temperature"
  const backPath = "/admin/devices/motor/mechanical"
  const subjectName = "этот температурный режим"
  //  const sections = [{ path: `/admin/devices/${endpointPath}/...`, label: "Мощность кВт" }]
  const texts = {
    title: "Температура нагрева двигателя в номинальном режиме, обозначается С",
    description:
      "Предельная t 130С - B, предельная t 155С  -F, предельная t 180С - H",
    addModalText: "Добавить температурный режим",
