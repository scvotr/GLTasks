...
export const BearingType = () => {
  const endpointPath = "technical/bearingType"
  ...
  const texts = {
    title: "Тип подшипника.	Роликовый и шариковый",
    description:
      "При радиальных нагрузках на вал предпочтительней роликовые подшипники.",
    addModalText: "Добавить тип подшипника",
