...
import { ProtectionSpecifications } from "./MainPageContent/ProtectionSpecifications"
...
export const Protection = () => {
  ...
  const sections = [
    { path: "/admin/devices/motor/protection/protectionLevel", label: "Степень защиты IP*" },
    { path: "/admin/devices/motor/protection/explosionProof", label: "Класс взрывозащиты" },
    { path: "/admin/devices/motor/protection/brake", label: "Наличие тормоза Ed" },
  ]
      ...
      <Box>
        <AppBar
          ...
          <Toolbar>
            ...
            <NavLink
              to="/admin/devices/motors/createMotor"
