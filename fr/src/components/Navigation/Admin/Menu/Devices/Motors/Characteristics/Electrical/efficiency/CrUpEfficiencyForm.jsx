...
export const CrUpEfficiencyForm = ({ onClose, isEdit, dataToEdit, popupSnackbar, response }) => {
  ...
  const handleSubmit = async e => {
    ...
    const endpoint = isEdit
      ? "/admin/devices/motor/electrical/efficiency/update"
      : "/admin/devices/motor/electrical/efficiency/create"
    try {
