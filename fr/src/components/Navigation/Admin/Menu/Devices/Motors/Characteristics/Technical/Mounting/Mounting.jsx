...
export const Mounting = () => {
  const endpointPath = "technical/mounting"
  const backPath = "/admin/devices/motor/technical"
  const subjectName = "это монтажное исполнение"
  //  const sections = [{ path: `/admin/devices/${endpointPath}/...`, label: "Мощность кВт" }]
  const texts = {
    title: "Монтажное исполнение. Обозначение IM1001 (указано значение для примера)",
    description:
    ...
    addModalText: "Добавить монтажное исполнение",
