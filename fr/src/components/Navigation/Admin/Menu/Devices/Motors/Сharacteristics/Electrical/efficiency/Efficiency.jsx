...
import { CrUpEfficiencyForm } from "./CrUpEfficiencyForm"

export const Efficiency = () => {
  //? const sections = [{ path: "/admin/devices/motor/efficiency/...", label: "Мощность кВт" }]
  ...
  const getData = useCallback(() => {
    const endpoint = "/admin/devices/motor/electrical/efficiency/read"
  ...
  const handleDelete = async () => {
    const endpoint = `/admin/devices/motor/electrical/efficiency/delete`
    try {
  ...
  return (
    <>
      <ModalCustom isOpen={modalOpen} onClose={closeModal} infoText="Добавить КПД электродвигателя">
        <CrUpEfficiencyForm
          onClose={closeModal}
          isEdit={isEdit}
      ...
      <HeaderWithNavigation
        title="КПД электродвигателя % (процент), обозначается ƞ "
        //? sections={sections}
      ...
      <Box>
        <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
          Отношение полезной мех. мощности на валу ЭД к активной подводимой элект. мощности.
        </Typography>
      </Box>
