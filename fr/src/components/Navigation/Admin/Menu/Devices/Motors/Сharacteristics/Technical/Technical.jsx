...
import { TechnicalSpecifications } from "./MainPageContent/TechnicalSpecifications"
...
export const Technical = () => {
  ...
  const sections = [
    { path: "/admin/devices/motor/technical/bearingType", label: "Тип подшипника" },
    { path: "/admin/devices/motor/technical/mounting", label: "Монтажное исполнение" },
    { path: "/admin/devices/motor/technical/dimensions", label: "Габарит" },
  ]
