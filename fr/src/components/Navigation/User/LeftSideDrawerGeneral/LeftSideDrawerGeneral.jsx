...
import { NestedGeneralListMenu } from "./NestedGeneralListMenu/NestedGeneralListMenu"
...
export const LeftSideDrawerGeneral = ({ currentUser, children }) => {
