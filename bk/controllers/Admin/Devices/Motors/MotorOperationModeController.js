...
class MotorOperationModeController extends BaseMotorController {
  constructor() {
    super('MotorOperationModeT') // Передаем имя таблицы в базовый класс
  }
...
module.exports = new MotorOperationModeController()