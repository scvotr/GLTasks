...
class MotorTemperatureController extends BaseMotorController {
  constructor() {
    super('MotorTemperatureT') // Передаем имя таблицы в базовый класс
  }
...
module.exports = new MotorTemperatureController()