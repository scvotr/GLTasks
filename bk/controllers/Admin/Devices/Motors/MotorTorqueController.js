...
class MotorTorqueController extends BaseMotorController {
  constructor() {
    super('MotorTorqueT') // Передаем имя таблицы в базовый класс
  }
...
module.exports = new MotorTorqueController()