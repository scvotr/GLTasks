...
//! WOW!! COOL
class MotorAmperageController extends BaseMotorController {
  constructor() {
    super('MotorAmperageT') // Передаем имя таблицы в базовый класс
  }
...
module.exports = new MotorAmperageController()
